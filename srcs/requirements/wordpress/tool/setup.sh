...
if [ ! -f /var/www/wordress/wp-config.php ]; then
	...
	wp core install --allow-root --url='tcosse.42.fr' --title='wordpress inception' --admin_user='tcosse' --admin_password='tcosse' --admin-email='tcosse@student.42.fr' --path='/var/www/wordpress'
